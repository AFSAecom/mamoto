...
export default async function MotoDetail({ params }: { params: { identifier: string } }) {
  const res = await getMotoFullByIdentifier(params.identifier);
  ...
  // Groupage Catégorie -> Sous-catégorie (DB only)
